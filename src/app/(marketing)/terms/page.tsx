    ...
    <>
      ...
      <main id="main">
        <article className="legal-doc">
          ...
          <p>Every account begins with a free trial that starts on signup and runs for the stated trial period (currently 7 days), with a stated included credit allowance. No payment method is required for the trial and nothing is charged automatically when it ends — when the trial period or its included credits run out, AI features are locked until you subscribe to the paid Pro plan. If you subscribe, your subscription is billed at the listed price and renews automatically on the same billing cycle until cancelled. You can cancel anytime from the billing portal; cancellation takes effect at the end of the current billing period.</p>

          <h2>4. Refunds &amp; chargebacks</h2>
          <p>If you believe you were charged in error, or want to cancel and request a refund, contact us at <strong>[support email]</strong> before filing a chargeback or payment dispute with your bank or card issuer — most billing issues can be resolved directly and faster that way. Filing a chargeback for a charge you authorized under these Terms may be contested using these Terms and your account&apos;s usage records as evidence that the charge was authorized. We reserve the right to suspend or terminate access for accounts with abusive chargeback activity.</p>
